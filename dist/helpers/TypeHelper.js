...
export class TypeHelper {
     ...
     */
    static convertStringToNumber(input, numericFields = []) {
        const result = { ...input };
     ...
     * @returns Objeto con valores convertidos
     */
    static convertStringToBoolean(input, booleanFields = []) {
        const result = { ...input };
     ...
     * @returns Objeto con valores convertidos
     */
    static convertStringToDate(input, dateFields = []) {
        const result = { ...input };
     ...
     */
    static validateAndClean(input, schema) {
        const result = {};
